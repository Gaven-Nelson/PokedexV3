...
import "/Users/gavennelson/Documents/PokedexProject3/pokedexReact/pokedexreactapp/src/Components/Details/DetailsV3.css";
...
function Details() {
  ...
  if (pokemon) {
    switch (true) {
      case pokemon.id < 10:
        ...
        spriteSugimoriBackId = "0" + "0" + (pokemon.id - 1);
        spriteSugimoriNextId = "0" + "0" + (pokemon.id + 1);
        break;
      case pokemon.id <= 101:
        sugimoriId = "0" + pokemon.id;
        spriteSugimoriBackId = "0" + (pokemon.id - 1);
        spriteSugimoriNextId = "0" + (pokemon.id + 1);
        break;
      default:
        sugimoriId = "" + pokemon.id;
        spriteSugimoriBackId = "" + (pokemon.id - 1);
        spriteSugimoriNextId = "" + (pokemon.id + 1);
    }
  }
  ...
  if (isLoading === true) {
    return (
      <Box justifyContent="center" height="1000" bg="#cce6e6">
        <Box w="100%">
          <Flex
      ...
      >
        <Box w="100%">
          ...
          >
            ...
            <Flex flexDirection="row" wrap="nowrap">
              {pokemon.id > 1 ? (
                <Button onClick={handleBackSprite}>
                  <Box>&#10094;</Box>
                  <Box>#{pokemon.id - 1}</Box>
                  <Image maxH="12" src={spritePixelBackURL} />
                </Button>
              ) : null}
            </Flex>
            ...
            <Flex flexDirection="row" wrap="nowrap">
              {pokemon.id < 553 ? (
                <Button onClick={handleNextSprite}>
                  <Image maxH="12" src={spritePixelNextURL} />
                  <Box>#{pokemon.id + 1}</Box>
                  <Box>&#10095;</Box>
                </Button>
              ) : null}
          ...
          >
            ...
            >
              ...
              <Flex
                ...
                color="gray"
              >
                <Box fontSize={["15", "10", "20"]}> #{pokemon.id}</Box>
              </Flex>
              <Flex
                flexBasis="50%"
              ...
              >
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="HP (Japanese: HP), short for Hit Point (Japanese: ヒットポイント Hit Point), is a stat that determines how much damage a Pokémon can receive before fainting."
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="The Attack stat (Japanese: 攻撃能力 attack ability, symbol A), or informally Physical Attack, partly determines how much damage a Pokémon deals when using a physical move."
                    >
                      Attack:
                    </Tooltip>
                  </Text>
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="The Defense stat (Japanese: 防御能力 defense ability, symbol B), or informally Physical Defense, partly determines how much damage a Pokémon receives when it is hit with a physical move."
                    >
                      Defense:
                    </Tooltip>
                  </Text>
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="The Speed stat (Japanese: 素早さ能力 speed ability, symbol S) determines the order of Pokémon that can act in battle. If Pokémon are moving with the same priority, Pokémon with higher Speed at the start of any turn will generally make a move before ones with lower Speed; in the case that two Pokémon have the same Speed, one of them will randomly go first."
                    >
                      Speed:
                    </Tooltip>
                  </Text>
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="The Special Attack stat (Japanese: 特攻能力 special attack ability, symbol C), or Sp. Atk for short, partly determines how much damage a Pokémon deals when using a special move."
                    >
                      Sp Atk:
                    </Tooltip>
                  </Text>
                ...
                >
                  <Text w="20%" paddingRight="2%" noOfLines={1}>
                    <Tooltip
                      borderRadius="10px"
                      label="The Special Defense stat (Japanese: 特防能力 special defense ability, symbol D), or Sp. Def for short, partly determines how much damage a Pokémon receives when it is hit with a special move."
                    >
                      Sp Def:
                    </Tooltip>
                  </Text>
                  <Box
                    ...
                    textColor="black"
                    borderRightColor={
                      (pokemon.types[1] || pokemon.types[0]) + ".100"
                    }
                    noOfLines={1}
                  >
            ...
            <Flex w="100%" color="black" fontWeight="normal" paddingTop="5%">
              <Box
                //border="1px"
                w="100%"
                padding="1"
